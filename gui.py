...
class App:
    ...
    def _build_ui(self) -> None:
        ...
        self.post_throw = self._spin(catch_grp, "post_throw", 9, 0, 3000, 1000)
        self.flee_taps = self._spin(catch_grp, "flee_taps", 10, 1, 6, 3)
        self.flee_gap = self._spin(catch_grp, "flee_gap", 11, 50, 1000, 200)
